 ...
 */
export type IndexByKey<T, Key extends PropertyKey> = T extends
  Record<string, unknown> ? { readonly [Name in keyof T]: T[Name] }
  : T extends ReadonlyArray<infer Item> ? {
      readonly [
        Value in Item extends Record<Key, PropertyKey> ? Item[Key] : never
      ]: Item;
    }
  : never;
