...
>;
export type ResponsePartEncoded = Schema.Codec.Encoded<
  ReturnType<typeof ResponsePart<any>>
>;
...
export const Part = <Tools extends Record<string, Tool.Any>>(
 ...
 */
export type Trajectory<Tools extends Record<string, Tool.Any>> =
  & PartStream<Tools>
...
export const encode = Effect.fn(
  ...
  > {
    ...
    const encodingContext = yield* Effect.context<
      typeof partSchema.EncodingServices
    >();
...
export const decode = Effect.fn(
  function* <Toolkits extends ReadonlyArray<Toolkit.Any>>(
    ...
    const decodingContext = yield* Effect.context<
      typeof partSchema.DecodingServices
    >();
    ...
    return Object.assign(parts, { toolkit }) as Trajectory<
